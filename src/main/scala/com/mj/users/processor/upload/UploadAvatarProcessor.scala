...
import com.mj.users.model.{UploadImageResponse, responseMessage, uploadAvatarResponse}
import com.mj.users.mongo.KafkaAccess
import reactivemongo.bson.{BSONDocument, BSONElement, BSONString}

import scala.concurrent.ExecutionContext.Implicits.global

class UploadAvatarProcessor extends Actor with MessageConfig with KafkaAccess {
